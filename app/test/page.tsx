  ...
  return (
    <div className="min-h-screen bg-gray-100 p-0 sm:p-12">
      <div className="mx-auto max-w-md px-6 py-12 bg-white border-0 shadow-lg sm:rounded-3xl">
        <h1 className="text-2xl font-bold mb-8">htmlForm With Floating Labels</h1>
        <form id="htmlForm" >
          ...
          <fieldset className="relative z-0 w-full p-px mb-5">
            <legend className="absolute text-gray-500 transhtmlForm scale-75 -top-3 origin-0">
              Choose an option
            </legend>
